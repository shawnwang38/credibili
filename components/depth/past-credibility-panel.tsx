...
export function PastCredibilityPanel({
  ...
  const delivered = fixturePastClaims.filter((c) => c.delivered).length;
  const rate = Math.round((delivered / fixturePastClaims.length) * 100);
